<template>
  <div>
    <work
      ...
      date="2015-2018"
      description="
      仮想空間上で地震による家屋の倒壊をシミュレーションし、がれきモデルを生成するためのツール。
      シミュレーションには剛体物理エンジンとしてNVIDIA社のPhysX 3.4を利用し、数千～数万個の剛体から構成されるシミュレーション空間を高速に処理している。
      また物理演算の過程はOpenGLを用いて描画している。
      生成したがれきモデルは、がれきモデルの解析や、レスキューロボットシミュレーションなどに利用できる。"
      source-address=""
    />
  </div>
</template>
